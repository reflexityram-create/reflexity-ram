...
5. Moved every scoped incident and closeout conversation found by the final
   mailbox searches to Gmail Trash: the duplicate-zone notice, the GitHub
   verification thread, and Pages notifications generated by the security and
   closeout pull requests.
...
| Mailbox | All scoped incident and closeout conversations present in Trash after deletion |
