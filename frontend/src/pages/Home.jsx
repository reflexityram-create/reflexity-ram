...
import { isPublicServerRam, RAM_CATEGORIES } from "@/lib/catalog";
...
const LANES = [
  {
    icon: Server,
    title: "Server memory",
    sub: "DDR4 · DDR5 · ALL SERVER FORM FACTORS",
    body: "Tested Server RAM modules and small lots, with exact compatibility details.",
